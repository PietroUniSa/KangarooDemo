...
<body>
    ...
    <p> Are you sure you're registered?
        If not, try to <a href="${pageContext.request.contextPath}/RegistrationServlet">register <i class="fa fa-user-plus" aria-hidden="true"></i></a>
    </p>

    <p> If you're already registered or you put the wrong login credentials...
        Retry <a href="${pageContext.request.contextPath}/LoginServlet">login <i class="fa fa-sign-in" aria-hidden="true"></i></a>
    </p>
